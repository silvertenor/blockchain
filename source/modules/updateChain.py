...
def updateBlockChain(date, new_hash, computer_id, pvsTx):
    ...
    store_transaction = dtContract.functions.addConfig(date, new_hash, computer_id, pvsTx).build_transaction(
        {
    ...
    print("Updated!")
    print(
        "New value of hash: " + dtContract.functions.retrieve().call()[0]
    )
