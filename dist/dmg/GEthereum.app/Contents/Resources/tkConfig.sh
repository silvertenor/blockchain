...
# installed.
TK_PREFIX='/opt/anaconda3/envs/block'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/opt/anaconda3/envs/block'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/opt/anaconda3/envs/block/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/opt/anaconda3/envs/block/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/opt/anaconda3/envs/block/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/opt/anaconda3/envs/block/lib/libtkstub8.6.a'
